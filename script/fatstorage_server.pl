...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{FATSTORAGE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{FATSTORAGE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
fatstorage_server.pl - Catalyst Testserver

=head1 SYNOPSIS

fatstorage_server.pl [options]
